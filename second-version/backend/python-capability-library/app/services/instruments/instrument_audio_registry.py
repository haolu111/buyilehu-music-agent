...
from app.services.instruments.instrument_timbre_catalog import EXACT_TIMBRE_DEFINITIONS, SAMPLE_LIBRARY
...
SOUNDFONT_ASSET_ROOT = Path(__file__).resolve().parents[2] / "static" / "assets" / "midi-js-soundfonts" / "FluidR3_GM"
