...
MATERIAL_BINDERS: dict[str, dict[str, Any]] = {
    ...
    "rhythm_pattern_binder": _binder(
        ...
        applicable_activity_ids=["rhythm_warmup", "lyrics_rhythm_practice", "lyrics_rhythm_reading", "meter_body_movement", "steady_beat_walk", "rhythm_question_answer", "body_percussion_builder", "ear_training_practice"],
    ...
    "graphic_score_binder": _binder(
        ...
        quality_gates=[
            "symbol_meaning_present",
            "meter_bound",
            "rhythm_value_check",
            "pitch_playback_mapping",
            "playback_mapping_ready",
        ],
    ),
