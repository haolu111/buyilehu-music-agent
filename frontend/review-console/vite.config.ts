  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        "rhythm-preview": resolve(__dirname, "rhythm-preview.html"),
        "composition-puzzle-preview": resolve(__dirname, "composition-puzzle-preview.html"),
        ...
        "virtual-instrument-player": resolve(__dirname, "virtual-instrument-player.html"),
