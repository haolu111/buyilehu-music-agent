...
export const VIRTUAL_INSTRUMENT_SOUNDBANK_BUILD_PLAN: VirtualInstrumentSoundbankBuildSpec[] = [
  ...
  // The custom VCSL pack is an independent two-key preset, not a General MIDI
  // percussion-bank preset. Sending it to channel 10 makes valid notes silent.
  { instrumentId: "virtual_frame_drum", presetName: "VCSL Frame Drum", program: 0, drum: false, midiNotes: [64, 63], sourceId: "vcsl_frame_drum_cc0", outputFormat: "sf2" },
