...
<template><div class="teacher-bar">
  ...
  <label>BPM<input type="number" min="40" max="160" :value="modelValue.metronome.bpm" @change="patchMetronome({bpm:Number(($event.target as HTMLInputElement).value)})"></label>
