...
exports.useAuthStore = (0, pinia_1.defineStore)('auth', {
    ...
    getters: {
        isLoggedIn: function (state) { return Boolean(state.token); },
    },
    actions: {
        login: function (username, password) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, authApi_1.authApi.login(username, password)];
                        case 1:
                            result = _a.sent();
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = this;
                            return [4 /*yield*/, authApi_1.authApi.me()];
                        case 1:
                            _a.user = _b.sent();
                            return [2 /*return*/];
                    }
