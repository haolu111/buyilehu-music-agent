...
from app.services.materials.default_music_material_library import choose_default_material_for_focus
from app.services.music.music_education_alignment import validate_music_education_alignment

# 把教师请求或教案分析结果转换成统一的活动规格
